        ...
        <Row className="text-center mb-2">
          <Col md={8} className="mx-auto">
            ...
            <p className="lead text-muted">
              Explore thought pieces, reflections, and insights from Sanjay and
              guests on leadership, psychology, and color theory.
            </p>
          </Col>
        </Row>
            ...
            <Col md={4} key={index}>
              <Card className="h-100 shadow-sm border-0">
                ...
                <Card.Body>
                  ...
                  <Card.Text className="">{article.excerpt}</Card.Text>
          ...
          <Col md={8}>
            <blockquote className="blockquote">
              <p className="fst-italic mb-3">
                "Leadership is not about standing above — it's about bringing
                others into the light."
              </p>
              <footer className="blockquote-footer">
                Kapono Ciotti,{" "}
                <cite title="Guest">Episode 7 - Leadership in Color</cite>
              </footer>
            </blockquote>
          </Col>
        </Row>
